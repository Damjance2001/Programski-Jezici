...
public class KlijentLogging {
    ...
    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.KlijentServiceImpl.findAll(..))")
    private void forFindAll() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.KlijentServiceImpl.findById(..))")
    private void forFindById() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.KlijentServiceImpl.save(..))")
    private void forSave() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.KlijentServiceImpl.deleteById(..))")
