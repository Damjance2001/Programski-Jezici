...
public class RezervacijaLogging {
    ...
    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.RezervacijaServiceImpl.findAll(..))")
    private void forFindAll() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.RezervacijaServiceImpl.findById(..))")
    private void forFindById() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.RezervacijaServiceImpl.save(..))")
    private void forSave() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.RezervacijaServiceImpl.deleteById(..))")
