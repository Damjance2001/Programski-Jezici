...
public class TuristickiPaketLogging {
    ...
    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.TuristickiPaketServiceImpl.findAll(..))")
    private void forFindAll() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.TuristickiPaketServiceImpl.findById(..))")
    private void forFindById() {

    }

    @Pointcut("execution(* com.asss.pj.TuristickaAgencija.service.TuristickiPaketServiceImpl.save(..))")
